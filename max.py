...
if __name__ == '__main__':
    ...
    while True:
        ...
        if "exit" in command:
            Speak("Sure mam! as your wish, Good bye")
            break
        if "insta" in command:
        ...
        if "How are you" in command:
            Speak("Iam fine! what about you Ananya?")
        if "Wish me" in command:
            Speak("Hey! ananya welcome back, and have a nice day")
        if "sing a song for me" in command:
            Speak("lalalaalalalala ahahahahhaahahahahah eheheehhehehehehe huhuhuhuhuhuhuhuh")